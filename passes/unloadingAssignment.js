...
class UnloadingAssignment extends mapper_1.ASTMapper {
    ...
    extractIndividualSubExpression(node, ast) {
        return ast.extractToConstant(node, (0, utils_1.typeNameFromTypeNode)((0, solc_typed_ast_1.getNodeType)(node, ast.compilerVersion), ast), `${nameModifiers_1.COMPOUND_ASSIGNMENT_SUBEXPRESSION_PREFIX}${this.counter++}`)[1];
    }
}
