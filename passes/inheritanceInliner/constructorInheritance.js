...
exports.solveConstructorInheritance = void 0;
...
/*
  ...
  ```
*/
function solveConstructorInheritance(node, ast, generator) {
    ...
    node.linearizedBaseContracts
        ...
        if (constructorFunc !== undefined) {
            ...
            const stmt = new solc_typed_ast_1.ExpressionStatement(ast.reserveId(), '', (0, functionGeneration_1.createCallToFunction)(newFunc, argList, ast));
...
exports.solveConstructorInheritance = solveConstructorInheritance;
...
function transformConstructor(node, newConstructor, statements, ast, generator) {
    ...
    const argList = newConstructor.vParameters.vParameters.map((v) => {
        return (0, nodeTemplates_1.createIdentifier)(v, ast);
    });
