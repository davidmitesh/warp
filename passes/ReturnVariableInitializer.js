...
class ReturnVariableInitializer extends mapper_1.ASTMapper {
    ...
    visitFunctionDefinition(node, ast) {
        ...
        [...(0, functionGeneration_1.collectUnboundVariables)(body).entries()]
            ...
            const newDeclStatement = new solc_typed_ast_1.VariableDeclarationStatement(ast.reserveId(), '', [newDecl.id], [newDecl], (0, defaultValueNodes_1.getDefaultValue)((0, solc_typed_ast_1.getNodeType)(decl, ast.compilerVersion), newDecl, ast));
