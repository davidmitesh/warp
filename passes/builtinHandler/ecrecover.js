...
class Ecrecover extends mapper_1.ASTMapper {
    visitFunctionCall(node, ast) {
        ...
        const ecrecoverEth = (0, functionGeneration_1.createCairoFunctionStub)('ecrecover_eth', [
        ...
        ], [['eth_address', (0, nodeTemplates_1.createUintNTypeName)(160, ast)]], ['range_check_ptr', 'bitwise_ptr', 'keccak_ptr'], ast, node);
