    ...
    visitMemberAccess(node, ast) {
        if (node.vExpression instanceof solc_typed_ast_1.Identifier &&
            ...
            if (node.memberName === 'number') {
                const replacementCall = (0, functionGeneration_1.createCallToFunction)((0, functionGeneration_1.createCairoFunctionStub)('warp_block_number', [], [['block_num', (0, nodeTemplates_1.createUint256TypeName)(ast)]], ['syscall_ptr', 'range_check_ptr'], ast, node), [], ast);
                ...
                const replacementCall = (0, functionGeneration_1.createCallToFunction)((0, functionGeneration_1.createCairoFunctionStub)('warp_block_timestamp', [], [['block_timestamp', (0, nodeTemplates_1.createUint256TypeName)(ast)]], ['syscall_ptr', 'range_check_ptr'], ast, node), [], ast);
                ast.replaceNode(node, replacementCall);
