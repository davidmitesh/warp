...
class ExplicitConversionToFunc extends mapper_1.ASTMapper {
    visitFunctionCall(node, ast) {
        ...
        if (node.kind !== solc_typed_ast_1.FunctionCallKind.TypeConversion)
            return;
        const typeNameType = (0, solc_typed_ast_1.getNodeType)(node.vExpression, ast.compilerVersion);
        ...
        const argType = (0, solc_typed_ast_1.generalizeType)((0, solc_typed_ast_1.getNodeType)(node.vArguments[0], ast.compilerVersion))[0];
        if (typeTo instanceof solc_typed_ast_1.IntType) {
            if (argType instanceof solc_typed_ast_1.FixedBytesType) {
                ...
                const replacementCall = (0, functionGeneration_1.createCallToFunction)((0, functionGeneration_1.createCairoFunctionStub)('felt_to_uint256', [['address_arg', (0, nodeTemplates_1.createAddressTypeName)(false, ast)]], [['uint_ret', (0, nodeTemplates_1.createUint256TypeName)(ast)]], [], ast, node), [node.vArguments[0]], ast);
        ...
        if (typeTo instanceof solc_typed_ast_1.AddressType) {
            if ((argType instanceof solc_typed_ast_1.IntType && argType.nBits == 256) ||
                ...
                const replacementCall = (0, functionGeneration_1.createCallToFunction)((0, functionGeneration_1.createCairoFunctionStub)('uint256_to_address_felt', [['uint_arg', (0, nodeTemplates_1.createUint256TypeName)(ast)]], [['address_ret', (0, nodeTemplates_1.createAddressTypeName)(false, ast)]], [], ast, node), [node.vArguments[0]], ast);
                ast.replaceNode(node, replacementCall);
