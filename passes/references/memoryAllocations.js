...
class MemoryAllocations extends referenceSubPass_1.ReferenceSubPass {
    ...
    allocateMemoryDynArray(node, ast) {
        ...
        const stub = (0, functionGeneration_1.createCairoFunctionStub)('wm_new', [
            ['len', (0, nodeTemplates_1.createUint256TypeName)(ast)],
            ['elemWidth', (0, nodeTemplates_1.createUint256TypeName)(ast)],
        ], [['loc', node.vExpression.vTypeName, solc_typed_ast_1.DataLocation.Memory]], ['range_check_ptr', 'warp_memory'], ast, node);
        const arrayType = (0, solc_typed_ast_1.generalizeType)((0, solc_typed_ast_1.getNodeType)(node, ast.compilerVersion))[0];
        ...
        const call = (0, functionGeneration_1.createCallToFunction)(stub, [node.vArguments[0], (0, nodeTemplates_1.createNumberLiteral)(elementCairoType.width, ast, 'uint256')], ast);
        const [actualLoc, expectedLoc] = this.getLocations(node);
