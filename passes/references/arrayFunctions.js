    ...
    visitMemberAccess(node, ast) {
        ...
        if (baseType instanceof solc_typed_ast_1.FixedBytesType) {
            ...
            if ((0, nodeTypeProcessing_1.isDynamicCallDataArray)(baseType)) {
                ...
                const funcStub = (0, functionGeneration_1.createCairoFunctionStub)('felt_to_uint256', [['cd_dstruct_array_len', (0, utils_1.typeNameFromTypeNode)(type, ast)]], [['len256', (0, utils_1.typeNameFromTypeNode)(type, ast)]], ['range_check_ptr'], ast, node, {
                    mutability: solc_typed_ast_1.FunctionStateMutability.Pure,
                    stubKind: cairoNodes_1.FunctionStubKind.FunctionDefStub,
                });
                const funcCall = (0, functionGeneration_1.createCallToFunction)(funcStub, [node], ast);
