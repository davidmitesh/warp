    ...
    visitAssignment(node, ast) {
        ...
        lhs.vOriginalComponents
            ...
            if (shouldRemove(node.vRightHandSide, emptyIndex))
                return;
            const tupleType = (0, solc_typed_ast_1.getNodeType)(node.vRightHandSide, ast.compilerVersion);
            ...
            const declaration = new solc_typed_ast_1.VariableDeclaration(ast.reserveId(), '', false, false, `${nameModifiers_1.TUPLE_FILLER_PREFIX}${this.counter++}`, scope, false, loc ?? solc_typed_ast_1.DataLocation.Default, solc_typed_ast_1.StateVariableVisibility.Default, solc_typed_ast_1.Mutability.Mutable, generalisedType.pp(), undefined, typeName);
