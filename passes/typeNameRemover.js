...
class TypeNameRemover extends mapper_1.ASTMapper {
    ...
    visitExpressionStatement(node, ast) {
        if ((node.vExpression instanceof solc_typed_ast_1.IndexAccess ||
            ...
            (0, solc_typed_ast_1.getNodeType)(node.vExpression, ast.compilerVersion) instanceof solc_typed_ast_1.TypeNameType) {
    ...
    isTypeNameType(rhs, index, ast) {
        ...
        return elem !== null ? (0, solc_typed_ast_1.getNodeType)(elem, ast.compilerVersion) instanceof solc_typed_ast_1.TypeNameType : false;
    }
}
