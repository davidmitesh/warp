    ...
    visitFunctionDefinition(node, ast) {
        ...
        if ((0, utils_1.isExternallyVisible)(node) && body !== undefined) {
            [...(0, functionGeneration_1.collectUnboundVariables)(body).entries()]
                ...
                (0, nodeTypeProcessing_1.isDynamicArray)((0, solc_typed_ast_1.getNodeType)(decl, ast.compilerVersion)))
                .forEach(([varDecl, ids]) => {
                ...
                if (varDecl.storageLocation === solc_typed_ast_1.DataLocation.Memory) {
                    ...
                    const memArrayStatement = (0, nodeTemplates_1.createVariableDeclarationStatement)([memoryArray], (0, nodeTemplates_1.createIdentifier)(dArrayStruct, ast), ast);
                    ids.forEach((identifier) => ast.replaceNode(identifier, (0, nodeTemplates_1.createIdentifier)(memoryArray, ast, solc_typed_ast_1.DataLocation.Memory)));
                    body.insertAfter(memArrayStatement, structArrayStatement);
                }
                else {
                    ids.forEach((identifier) => ast.replaceNode(identifier, (0, nodeTemplates_1.createIdentifier)(dArrayStruct, ast, solc_typed_ast_1.DataLocation.CallData)));
                }
