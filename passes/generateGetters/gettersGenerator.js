    ...
    visitContractDefinition(node, ast) {
        node.vStateVariables.forEach((v) => {
            ...
            if (v.stateVariable && v.visibility === solc_typed_ast_1.StateVariableVisibility.Public) {
                ...
                const getter = new solc_typed_ast_1.FunctionDefinition(funcDefID, '', node.id, solc_typed_ast_1.FunctionKind.Function, v.name, false, solc_typed_ast_1.FunctionVisibility.Public, solc_typed_ast_1.FunctionStateMutability.View, false, fnParams, returnParameterList, [], undefined, getterBody);
...
function genReturnParameters(vType, funcDefID, ast) {
    ...
    const newVarDecl = (type, dataLocation = solc_typed_ast_1.DataLocation.Default) => {
        ...
        return new solc_typed_ast_1.VariableDeclaration(ast.reserveId(), '', false, false, '', funcDefID, false, dataLocation, solc_typed_ast_1.StateVariableVisibility.Internal, solc_typed_ast_1.Mutability.Mutable, type.typeString, undefined, (0, cloning_1.cloneASTNode)(type, ast));
    };
    if (vType instanceof solc_typed_ast_1.ElementaryTypeName) {
        if ((0, nodeTypeProcessing_1.isReferenceType)((0, solc_typed_ast_1.getNodeType)(vType, ast.compilerVersion))) {
        ...
        if (vType.vReferencedDeclaration instanceof solc_typed_ast_1.StructDefinition) {
            ...
            vType.vReferencedDeclaration.vMembers.forEach((v) => {
                ...
                returnVariables.push(newVarDecl(v.vType, (0, nodeTypeProcessing_1.isReferenceType)((0, solc_typed_ast_1.getNodeType)(memberTypeName, ast.compilerVersion))
...
function genFunctionParams(varCount, vType, funcDefID, ast) {
    ...
    */
    if (!vType || vType instanceof solc_typed_ast_1.ElementaryTypeName) {
        ...
        return [
            new solc_typed_ast_1.VariableDeclaration(ast.reserveId(), '', false, false, `_i${varCount}`, funcDefID, false, solc_typed_ast_1.DataLocation.Default, solc_typed_ast_1.StateVariableVisibility.Internal, solc_typed_ast_1.Mutability.Mutable, 'uint256', undefined, (0, nodeTemplates_1.createUint256TypeName)(ast)),
            ...genFunctionParams(varCount + 1, vType.vBaseType, funcDefID, ast),
        ];
    }
    else if (vType instanceof solc_typed_ast_1.Mapping) {
        return [
            new solc_typed_ast_1.VariableDeclaration(ast.reserveId(), '', false, false, `_i${varCount}`, funcDefID, false, (0, base_1.locationIfComplexType)((0, solc_typed_ast_1.getNodeType)(vType, ast.compilerVersion), solc_typed_ast_1.DataLocation.Memory), solc_typed_ast_1.StateVariableVisibility.Internal, solc_typed_ast_1.Mutability.Mutable, vType.vKeyType.typeString, undefined, (0, cloning_1.cloneASTNode)(vType.vKeyType, ast)),
        ...
        if (vType.vReferencedDeclaration instanceof solc_typed_ast_1.StructDefinition) {
            ...
            */
            ...
            const tempStructVarDeclaration = (type, initialValue) => {
                const structVarDecl = new solc_typed_ast_1.VariableDeclaration(ast.reserveId(), '', false, false, `_temp${tempCount++}`, getter.id, false, solc_typed_ast_1.DataLocation.Storage, solc_typed_ast_1.StateVariableVisibility.Internal, solc_typed_ast_1.Mutability.Mutable, type.typeString, undefined, (0, cloning_1.cloneASTNode)(type, ast));
