...
class StaticArrayIndexer extends mapper_1.ASTMapper {
    constructor() {
        ...
        */
        ...
        this.staticArrayAccesed = new Map();
    }
    ...
    staticIndexToMemory(node, ast) {
        ...
        const parentFunction = node.getClosestParentByType(solc_typed_ast_1.FunctionDefinition);
        (0, assert_1.default)(parentFunction !== undefined, 'Calldata types must be enclosed in a function definition');
    ...
    setExpressionToMemory(expr, refVarDecl, ast) {
        const exprType = (0, solc_typed_ast_1.getNodeType)(expr, ast.compilerVersion);
    ...
    initMemoryArray(identifier, parentFunction, ast) {
        const refId = identifier.referencedDeclaration;
        const memoryType = (0, solc_typed_ast_1.generalizeType)((0, solc_typed_ast_1.getNodeType)(identifier, ast.compilerVersion))[0];
        const varDecl = new solc_typed_ast_1.VariableDeclaration(ast.reserveId(), '', false, false, `${nameModifiers_1.CALLDATA_TO_MEMORY_PREFIX}${identifier.name}`, parentFunction?.id, false, solc_typed_ast_1.DataLocation.Memory, solc_typed_ast_1.StateVariableVisibility.Internal, solc_typed_ast_1.Mutability.Mutable, memoryType.pp(), undefined, (0, utils_1.typeNameFromTypeNode)(memoryType, ast), undefined);
        (0, assert_1.default)(identifier.vReferencedDeclaration instanceof solc_typed_ast_1.VariableDeclaration);
        ...
        const varDeclStmnt = new solc_typed_ast_1.VariableDeclarationStatement(ast.reserveId(), '', [varDecl.id], [varDecl], assignation);
...
function hasIndexAccess(node, ast) {
    return ((node instanceof solc_typed_ast_1.IndexAccess &&
        ((isCalldataStaticArray((0, solc_typed_ast_1.getNodeType)(node.vBaseExpression, ast.compilerVersion)) &&
