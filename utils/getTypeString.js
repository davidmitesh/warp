...
exports.generateExpressionTypeString = exports.generateLiteralTypeString = exports.getReturnTypeString = exports.getFunctionTypeString = exports.getEnumTypeString = exports.getStructTypeString = exports.getContractTypeString = exports.getDeclaredTypeString = void 0;
...
function getFunctionTypeString(node, compilerVersion, nodeInSourceUnit) {
    const inputs = node.vParameters.vParameters
        .map((decl) => {
        const baseType = (0, solc_typed_ast_1.getNodeTypeInCtx)(decl, compilerVersion, nodeInSourceUnit ?? decl);
...
function getReturnTypeString(node, ast, nodeInSourceUnit) {
    ...
    const parametersTypeString = retParams
        .map((decl) => {
        const type = (0, solc_typed_ast_1.getNodeTypeInCtx)(decl, ast.compilerVersion, nodeInSourceUnit ?? decl);
...
function instanceOfNonRecursivePP(type) {
    return (type instanceof solc_typed_ast_1.AddressType ||
        ...
        type instanceof solc_typed_ast_1.ModuleType ||
